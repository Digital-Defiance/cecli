...
```
bright-vision-core 0.23.0 requires somepackage==X.Y.Z, but you have somepackage U.W.V which is incompatible.
```

## Install with uv tool install cecli-dev, uv or pipx

If you are having dependency problems you should consider
[installing cecli using uv tool install cecli-dev, uv or pipx](/docs/install.html).
...
[install cecli using uv tool install cecli-dev, uv or pipx](/docs/install.html).
