...
[benchmark results data files](https://github.com/dwash96/cecli/blob/main/bright_vision_core/website/_data/).
...
files = [
    'bright_vision_core/website/docs/leaderboards/edit.md',
    'bright_vision_core/website/_data/edit_leaderboard.yml',
]
