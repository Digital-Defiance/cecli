...
Make sure you have access to these models in your AWS account before using them with cecli.

## Install boto3
You may need to install the `boto3` package.

```bash
# If you installed with uv tool or `uv tool`
uv tool run --from bright-vision-core pip install boto3

# Or with pipx...
pipx inject bright-vision-core boto3
