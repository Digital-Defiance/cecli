...
can also
[download from GitHub](https://github.com/dwash96/cecli/blob/main/bright_vision_core/website/assets/sample.cecli.conf.yml).

<!--[[[cog
from bright_vision_core.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("bright_vision_core/website/assets/sample.cecli.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
