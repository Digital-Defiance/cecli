...
description: Watch how cecli adds support for tons of new programming languages by integrating with tree-sitter-language-pack. Demonstrates using cecli to script downloading a collection of files, and using ad-hoc bash scripts to have cecli modify a collection of files.
---
