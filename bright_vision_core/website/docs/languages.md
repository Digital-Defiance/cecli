...
language parsers.
This makes it easy for users to pip install bright-vision-core in many diverse environments.
...
<!--[[[cog
from bright_vision_core.repomap import get_supported_languages_md
