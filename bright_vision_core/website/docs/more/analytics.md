...
[sample analytics logs](https://github.com/cecli-ai/cecli/blob/main/bright_vision_core/website/assets/sample-analytics.jsonl).
...
[GitHub Issue](https://github.com/cecli-ai/cecli/issues).
