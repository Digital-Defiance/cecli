...
parent: More info
nav_order: 400
description: CLI scripting, Python API, and bright-vision-core-serve HTTP API.
---
...
# default http://127.0.0.1:8741 — see bright_vision_core/http_api.py
```
...
You can script the engine via the command line or Python (CLI: `cecli`, also `aider-ce`; HTTP: `bright-vision-core-serve`).
...
```python
from bright_vision_core.coders import Coder
from bright_vision_core.models import Model
