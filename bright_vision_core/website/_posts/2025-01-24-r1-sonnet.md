---
title: R1+Sonnet set SOTA on cecli's polyglot benchmark
excerpt: R1+Sonnet has set a new SOTA on the cecli polyglot benchmark. At 14X less cost compared to o1.
...
# R1+Sonnet set SOTA on cecli's polyglot benchmark
{: .no_toc }

<canvas id="editChart" width="800" height="450" style="margin-top: 20px"></canvas>

Cecli supports [using a pair of models for coding](https://cecli.dev/2024/09/26/architect.html):
...
[cecli polyglot benchmark](/2024/12/21/polyglot.html).
...
Once you [pip install bright-vision-core](https://cecli.dev/docs/install.html),
you can use cecli, R1 and Sonnet like this:

```bash
export DEEPSEEK_API_KEY=<your-key>
export ANTHROPIC_API_KEY=<your-key>

cecli --architect --model r1 --editor-model sonnet
```
...
cecli --architect --model openrouter/deepseek/deepseek-r1 --editor-model openrouter/anthropic/claude-3.5-sonnet
```

## Thinking output

There has been 
[some recent discussion](https://github.com/dwash96/cecli/pull/2973)
...
final output. 
R1 is configured in cecli's standard architect role with Sonnet as editor.
