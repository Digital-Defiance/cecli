---
title: o1 tops cecli's new polyglot leaderboard
excerpt: o1 scores the top result on cecli's new multi-language, more challenging coding benchmark.
...
# o1 tops cecli's new polyglot leaderboard
{: .no_toc }
...
new 
[cecli polyglot leaderboard](/docs/leaderboards/), significantly ahead of
other top LLMs.
The new polyglot benchmark uses many popular coding languages
and was designed to be 
*much more challenging* than cecli's original
...
{: .note :}
See the main 
[cecli leaderboard](https://cecli.dev/docs/leaderboards/)
...
Like cecli's original code editing benchmark,
...
Cecli's original code editing benchmark was 
...
[cecli polyglot benchmark repo](https://github.com/Aider-AI/polyglot-benchmark)
on GitHub.
