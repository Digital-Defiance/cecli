...
[cecli's code editing leaderboard](https://cecli.dev/docs/leaderboards/)
...
You can code with all of these models using cecli like this:
...
$ cecli --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ cecli --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ cecli --model openrouter/meta-llama/llama-3.1-405b-instruct
$ cecli --model openrouter/meta-llama/llama-3.1-70b-instruct
$ cecli --model openrouter/meta-llama/llama-3.1-8b-instruct
```

See the
[installation instructions](https://cecli.dev/docs/install.html)
and other
[documentation](https://cecli.dev/docs/usage.html)
for more details.
...
secured #7 on cecli's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on cecli's code editing
benchmark. 
