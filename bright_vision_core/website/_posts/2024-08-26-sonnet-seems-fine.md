...
excerpt: Sonnet's score on the cecli code editing benchmark has been stable since it launched.
...
[cecli code editing benchmark](/docs/benchmarks.html#the-benchmark)
via the API.
...
to evaluate the effects of small changes to cecli's system prompts.
...
> The 
> [cecli LLM code editing leaderboard](https://cecli.dev/docs/leaderboards/)
