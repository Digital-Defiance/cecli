---
title: o1-preview is SOTA on the cecli leaderboard
...
# OpenAI o1-preview is SOTA on the cecli leaderboard
...
OpenAI o1-preview scored 79.7% on cecli's code editing benchmark,
...
It is much more practical to use cecli's
...
The o1-preview model had trouble conforming to cecli's diff edit format.
The o1-mini model had trouble conforming to both the whole and diff edit formats.
Cecli is extremely permissive and tries hard to accept anything close
...
It seems likely that cecli could optimize its prompts and edit formats to
better harness the o1 models.


## Using cecli with o1

OpenAI's new o1 models are supported in v0.57.0 of cecli:
...
> based on cecli v0.56.1-dev.
> See the [cecli leaderboards](/docs/leaderboards/) for up-to-date results
> based on the latest cecli releases.
