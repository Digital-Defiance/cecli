...
> Figure 1: Cecli coding benchmark scores of models using either plain markdown text or JSON to return code.
...
People often ask why cecli uses a plain text format for LLMs to specify code edits (below),
...
Previous [cecli benchmark results](/2023/07/02/benchmarks.html)
showed
...
the 
[cecli "code editing" benchmark](/2023/07/02/benchmarks.html#the-benchmark)
...
cecli's "whole" edit format, where the
...
#### Notes on the cecli leaderboard

*The results presented here are not directly comparable to results
from the main
[cecli LLM leaderboard](https://cecli.dev/docs/leaderboards/).
