...
install() {
    ...
    say ""
    say "Installing cecli..."
    say ""
    # Install bright-vision-core using the newly installed uv
    ensure "${_install_dir}/uv" tool install --force --python python3.12 --with pip bright-vision-core@latest
